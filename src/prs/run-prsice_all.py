...
"""Estimate genome wide polygenic scores with PRSice from PLINK2 GWAS outputs.
"""
...
def main(config_file):
    ...
    gwas_suffix = "all-sans"
    gwas_dataset = "ukb-all_maf001"
    ...
    for pheno in config.phe_list:
        ...
        gwas_file = os.path.join(gwas_dir, "all." + pheno + "." + pheno + ".glm.linear")
